...
al~\cite{Ni2014} study the trade-off between the loss of precision, compression
...
highly constrained and Daly/Young's formula is not appropriate, which is a common
scenerio on many leadership-class systems.
