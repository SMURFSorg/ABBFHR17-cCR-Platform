...
First, unlike a number of the previous studies, our technique, based on
APEX workflows report on the Cielo platform, considers existing
platform I/O. Additionally, our approach is agnostic to the I/O patterns of
the considered applications as long as they are known.  We attempt to optimize
