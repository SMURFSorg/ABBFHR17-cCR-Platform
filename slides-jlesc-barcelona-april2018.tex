...
\includegraphics[width=1cm,height=1.26cm]{photos/bob.jpg}
...
\vspace{-1cm}
Optimal Period is computed assuming a checkpoint cost

Interference between checkpointing I/O of App 1 and App 2 change the
checkpoint time\\
$\qquad\Rightarrow$ Applications checkpoint too often\\
$\qquad\Rightarrow$ There is no optimal period

\textcolor{red}{When to checkpoint}, in a shared environment,\\
$\qquad$ since the \textcolor{red}{checkpoint cost is not predictible}?
...
%             & 
               ...
               {\small I/O (checkpoint or init/fini) is served First come -
               First served. If another application is being served,
               they wait in turn}\par
...
%               \\
             ...
             {\small I/O (checkpoint or init/fini) is served First come -
             First served, but in case of checkpoints, continue
             working until you are served}\par
...
%             &
               ...
               $\Rightarrow$ \textcolor{blue}{Daly period} is embedded in the
               scheduling: no checkpoint is served if trying to
