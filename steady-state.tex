...
execution.  Given the above, we determine the optimal checkpointing period for each application class
...
\todo[inline]{The text does not reflect my understanding (based on what Thomas described) of the problem.}
