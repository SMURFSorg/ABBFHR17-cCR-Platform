...
\RRresume{Ce rapport propose un modèle et une étude analytique de la réplication en tant que technique
pour détecter et corriger les erreurs silencieuses. 
Nous donnons également les résultats d'un ensemble de simulations qui viennent corroborer le modèle analytique.}
...
\RRmotcle{résilience, checkpoint, optimisation I/O.}

\RRkeyword{resilience, checkpoint, I/O pressure, cooperative checkpoint.}
