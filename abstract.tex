...
% Primary: George & Dorian
  ...
  applications, I/O loads resulting from checkpoint/restart (CR)
  services used to protect the parallel applications from platform
  faults increase the contention and will lead to an additional
