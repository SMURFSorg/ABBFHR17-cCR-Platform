...
% Primary: George & Dorian
  ...
  this work, we consider a cooperative I/O scheduling policy that optimizes they way
  concurrently executing, CR-based applications share interconnection networks.
  Using our cooperative policy, applications checkpoint sequentially, with a dynamic,
