...
are being considered to integrate these components into the
supercomputers to serve as distributed scalable storage mechanisms and
reduce the I/O contention (see~\cite{amm2014} extended
in~\cite{ammecp2018} for a taxonomy of envisionned architectures). We
