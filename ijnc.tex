...
of failures) place an additional burden since it increases I/O contention,
...
performance, thereby maximizing platform throughput. We then consider
how specialized hardware (namely burst buffers) may impact the I/O
contention problem, and evaluate if they are an alternative solution
to I/O scheduling.
