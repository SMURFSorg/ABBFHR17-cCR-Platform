...
buffer, of local bandwidth capacity of 10GB/s, and that is used to
...
\begin{figure}
  \begin{center}
    \resizebox{1.05\linewidth}{!}{\input{sim/figures/cielo-bb-diff-1h.tex}}
  \end{center}
...
\begin{figure}
  \begin{center}
    \resizebox{1.05\linewidth}{!}{\input{sim/figures/cielo-bb-diff-daly.tex}}
  \end{center}
