...
\begin{itemize}
  ...
  hence the waste $\wapp{i}{j}$ is 
     $$\wapp{i}{j} = \frac{v_{i}}{\mu_{i} } q_{j} (R_{j} + d_{j} + \frac{v_{i}}{2}) = 
...
$$\wap{i} = \sum_{A_{j} \in \Catiocat, j\neq i} \wapp{i}{j} + \sum_{A_{j} \in \Ckptcat} \wapp{i}{j}$$
We obtain
\begin{equation}
\label{eq.selection}
...
\end{equation}
 ...
 \begin{equation}
\label{eq.selection2}
 \wap{i} = C_{i} \times \left( \sum_{1 \leq j \leq r} q_{j} (d_{j} + v_{i}) 
 + \sum_{r+1 \leq j \leq r+s, j\neq i}   \frac{q^{2}_{j}}{\muind} (R_{j} + d_{j} + \frac{v_{i}}{2}) \right)
\end{equation}
