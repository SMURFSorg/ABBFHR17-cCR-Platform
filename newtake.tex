...
The theorem does provide a lower bound for the platform waste.\todo{the 2 storages holds only after the optimization, doesn't it? Or is it also a consequence of the above "proof" sketch?}
